...
{
    public  class QueueEndPoint : IEndPoint
    {
        ...
        private QueueEndPoint(QueueEndPoint endPoint)
            : this(endPoint._ipAddress, endPoint._port, endPoint.QueueName)
        { 
        }

        private QueueEndPoint(IPAddress ipAddress, int port, string queueName)
        {
        ...
        public static QueueEndPoint Parse(string endPoint)
        {
            ...
            return new QueueEndPoint(host,port, array[2]);
        }
        ...
        {
            var endPoint = obj as QueueEndPoint;
